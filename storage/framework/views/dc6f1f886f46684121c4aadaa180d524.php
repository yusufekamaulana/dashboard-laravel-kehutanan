...
<body>
                            ...
                            <div class="row">
                                <div class="col-sm-4 stretch-card grid-margin">
                                    <div class="card datatext-card red">
                                        <div class="card-body">
                                            <p><?php echo e(number_format($totalForestData2022->Total_Hutan_Lindung)); ?> Ha</p>
                                ...
                                <div class="col-sm-4 stretch-card grid-margin">
                                    <div class="card datatext-card blue">
                                        <div class="card-body">
                                            <p><?php echo e(number_format($totalForestData2022->Total_Suaka_Alam_dan_Pelestarian_Alam)); ?> Ha</p>
                                ...
                                <div class="col-sm-4 stretch-card grid-margin">
                                    <div class="card datatext-card yellow">
                                        <div class="card-body">
                                            <p><?php echo e(number_format($totalForestData2022->Total_Hutan_Produksi_Terbatas)); ?> Ha</p>
                                ...
                                <div class="col-sm-4 stretch-card grid-margin">
                                    <div class="card datatext-card gren">
                                        <div class="card-body">
                                            <p><?php echo e(number_format($totalForestData2022->Total_Hutan_Produksi_Tetap)); ?> Ha</p>
                                ...
                                <div class="col-sm-4 stretch-card grid-margin">
                                    <div class="card datatext-card purp">
                                        <div class="card-body">
                                            <p><?php echo e(number_format($totalForestData2022->Total_Hutan_Produksi_yang_dapat_Dikonversi)); ?> Ha</p>
                                ...
                                <div class="col-sm-4 stretch-card grid-margin">
                                    <div class="card datatext-card green">
                                        <div class="card-body">
                                            <p><?php echo e(number_format($totalForestData2022->Total_Jumlah_Luas_Hutan_dan_Perairan)); ?> Ha</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const forestData = <?php echo json_encode($forestData2022, 15, 512) ?>;
...
</html><?php /**PATH Z:\KULIAH\SEMESTER 5\IAK\dashboard\resources\views/forest/index.blade.php ENDPATH**/ ?>