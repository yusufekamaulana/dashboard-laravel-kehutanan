...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const forestData = <?php echo json_encode($pelakuindustri2022, 15, 512) ?>;
    ...
    <script>
        const dataAkasia = <?php echo json_encode($produksiAkasia, 15, 512) ?>;
        const dataKayuIndah = <?php echo json_encode($produksiIndah, 15, 512) ?>;
        const dataMeranti = <?php echo json_encode($produksiMeranti, 15, 512) ?>;
        const dataRimbaCampuran = <?php echo json_encode($produksiCampuran, 15, 512) ?>;
...
</html><?php /**PATH Z:\KULIAH\SEMESTER 5\IAK\dashboard\resources\views/produksi/index.blade.php ENDPATH**/ ?>