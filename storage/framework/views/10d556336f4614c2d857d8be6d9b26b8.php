            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form class="forms-sample" action="<?php echo e(route('actionlogin')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-rounded btn-primary btn-lg mr-2"> Login </button>
                            </div>
                            <br>
...
</html><?php /**PATH Z:\KULIAH\SEMESTER 5\IAK\dashboard\resources\views/login.blade.php ENDPATH**/ ?>